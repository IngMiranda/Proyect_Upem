...
INNER JOIN plantel c ON b.fk_plantel= c.id_plantel
        ...
        labelConcepto.innerText = selectConcepto.value;
                ...
                <script>
                    function actualizarLabel() {
                        ...
                        var p_v = opcionSeleccionada.split("$valor['id_clave_concepto'] ")[1];
                        labelConcepto.innerText = $valor["'$valor['p_v']'"];
                    }
                    <?php
                        }
                    ?>
                ...
                <div class="mb-3">
                    ...
                    // $fk_clave_concepto = "SELECT * FROM concepto_pago";
                    ?>
                    <label for="example_motor" class="form-label">clave concepto</label>
